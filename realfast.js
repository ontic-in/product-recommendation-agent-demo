...
function openChat() {
  var chatButton = document.querySelector(
...
function initEmbeddedMessaging() {
  try {
    ...
    embeddedservice_bootstrap.init(AGENT_ID, AGENT_NAME, AGENT_URL, {
      scrt2URL:
        "https://realfast-ai--sandboxjtb.sandbox.my.salesforce-scrt.com",
    });

    // Check if widget was previously opened
    var widgetStorage = localStorage.getItem(
      "".concat(AGENT_ID, "_WEB_STORAGE")
    );
